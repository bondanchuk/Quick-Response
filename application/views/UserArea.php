		...
		<header class="tt-header-1">
				...
				<div class="container">
						...
						<div class="top-inner">
							...
							<a class="logo" href="index.html"><img src="<?php echo base_url();?>img/Edit_7.png" alt=""></a>
						...
						<div class="toggle-block">
								...
								<nav class="main-nav clearfix">
										...
										<ul>
												...
												<li>
														...
														<a href="<?php echo base_url();?>index.php/DaftarLaporan">Daftar Laporan <i class="menu-toggle fa fa-angle-down"></i></a>
								...
								<div class="nav-more">
									...
									<p class="text-center"><a href="Dashboard/logout" class="c-btn type-1 size-2 font-2 color-3 " role="submit" ><span>Keluar</span></a></p>
								...
								<div class="top-line">
									...
									<div class="container">
								                             ...
								                             <a href="tel:18004567890">+ (62) 771-4575022</a>
								                         </div>
								                         <div class="top-info">
								                             <i class="fa fa-envelope-o"></i>
								                             <a href="mailto:dpu@kepriprov.go.id">dpu@kepriprov.go.id</a>
								                         </div>
    ...
    <div id="content-wrapper">
        ...
        <div class="tt-pagelabel background-block" style="background-image:url(img/breadcrumbs/breadcrumbs.jpg);">
            ...
            <div class="container">
                ...
                <h1 class="tt-pagelabel-title">user dashboard</h1>
	        ...
	        <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-md-push-4">
                        ...
                        <h3 class="tt-block-title c-h3">Data Pengaduan</h3>

                        <div class="empty-space marg-lg-b50 marg-md-b30"></div>
<h5>Untuk pelaporan menggunakan perangkat mobile, tidak perlu memilih lokasi pada maps/peta. Maps berlkau untuk perangkat komputer/laptop.</h5>

												<?php echo validation_errors('<p class="error">'); ?>

													<form action="<?=base_url()?>index.php/Dashboard/UploadLaporan" method="post" enctype="multipart/form-data">
                            ...
                            <div class="tt-request-form">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <h5 class="c-input-label">Kota/Kabupaten</h5>

																						<select name="Kabupaten" class="c-input size-2 color-2" id="Kabupaten">

    <option class="c-input size-2 color-2" value=""> --Pilih-- </option>

    <?php foreach ($kotakab as $kab) {

      echo '<option class="c-input size-2 color-2" value="'.$kab->idKota.'">'.$kab->namaKota.'</option>';
    ...
    ?>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <h5 class="c-input-label">Nama Jalan</h5>

                                            <input class="c-input size-2 color-2" name="namaJalan" id="namaJalan" autocomplete="off" required type="text" placeholder="Ex. Jln. Soekarno Hatta" >

																						<ul class="dropdown-menu txtcountry"  role="menu" aria-labelledby="dropdownMenu"  id="DropdownCountry">
																				...
																				<div class="panel-heading"><span class="fa fa-globe "></span> Pilih Lokasi</div>
						  ...
						  <div class="col-sm-6">
								  ...
								  <h5 class="c-input-label">Latitude</h5>

									<input type="text" class="c-input size-2 color-2" name="latitude" id="latitude" readonly>
							...
							<div class="col-sm-6">
								  ...
								  <h5 class="c-input-label">Longitude</h5>

									<input type="text" class="c-input size-2 color-2" name="longitude" id="longitude" readonly>
                                    ...
                                    <h5 class="c-input-label">Judul Laporan</h5>

                                    <input class="c-input size-2 color-2" name="judulLaporan" required="" type="text" placeholder="Ex. Jalan Rusak atau Jalan Berlubang">



                                    <h5 class="c-input-label">Detail Laporan</h5>

                                    <textarea class="c-area color-2 size-2" name="detailLaporan" required="" placeholder="Ex. Detail lokasi didepan hotel xxx"></textarea>



																		<h5 class="c-input-label">Unggah Foto (Max Size 2Mb)</h5>



																		<input class="c-input size-2 color-2" name="filefoto" required="" type="file" accept="image/*">

<div class="empty-space marg-lg-b25 marg-md-b10"></div>



                                    <div class="c-btn type-1 size-2 font-2 color-4">

                                       <input type="submit" value="kirim lapor">
                    ...
                    <div class="col-md-4 col-md-pull-8">
                        ...
                        <h3 class="tt-block-title c-h3">informasi pelapor</h3>
                        ...
                        <div class="tt-contact clearfix">
                            ...
                            <div class="tt-contact-info">
                                ...
                                <div class="simple-text size-3"><?php foreach ($user as $m):?>

                                    <p><?php echo $m->namaLengkap ?>
...
<!--
                        ...
                        <h3 class="tt-block-title c-h5">working hours</h3>
                        ...
                        <div class="tt-working">
                            ...
                            <div class="tt-working-row">
                                ...
                                <div class="tt-working-cell">Monday to Friday :</div>

                                <div class="tt-working-cell">8.00am to 5.00 pm</div>

                            </div>

                            <div class="tt-working-row">

                                <div class="tt-working-cell">Saturday :</div>

                                <div class="tt-working-cell">8.00am to 3.00 pm</div>

                            </div>

                            <div class="tt-working-row">

                                <div class="tt-working-cell">Sunday :</div>
            ...
            <div class="container">
                ...
                <div class="empty-space marg-lg-b115 marg-md-b50 marg-sm-b30"></div>
  ...
  <script src="<?php echo base_url();?>assets/js/global.js"></script>
    ...
    function submitForm() {
		...
		center: new google.maps.LatLng(1.0479375,104.3094055),
		...
		*/
		...
		$.ajax({
			...
			url : '<?php echo site_url("index.php/admin/hapusmarkerjembatan") ?>',
		...
		$.ajax({
			...
			url : '<?php echo site_url("index.php/admin/viewmarkerjembatan") ?>',
