            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <h4 class="page-title">MENU DAFTAR LAPORAN TERSELESAIKAN</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-13">
                        ...
                        <div class="card-box table-responsive">
                            ...
                            <h4 class="m-t-0 header-title"><b>Tabel Daftar LAPORAN terselesaikan</b></h4>

                              <h5><i>Menampilkan daftar pengaduan yang sudah diselesaikan perbaikannya. Klik detail untuk mengupdate status laporan.</i></h5>
                            ...
                            <table id="table" class="hover dt-responsive" cellspacing="0" width="100%" >
                                  ...
                                  <thead>
                                    ...
                                    <tr>
                                      ...
                                      <th style="text-align: center;width:165px;">Foto Laporan</th>

                                      <th style="text-align: center;width:155px;">Status Laporan</th>
                                  ...
                                  responsive: true,
                                          ...
                                          "ajax": {
                                              ...
                                              "url": "<?php echo site_url('Admin/Terselesaikan/ajax_list')?>",
...
<ul class="list-inline chart-detail-list">
                                    ...
                                    <li>
                                        ...
                                        <h5><i class="fa fa-circle m-r-5" style="color: #ffbd4a;"></i>Pending (Menunggu Konfirmasi User)</h5>

                                    </li>

                                    <li>

                                        <h5><i class="fa fa-circle m-r-5" style="color: #5d9cec;"></i>Terselesaikan</h5>
          ...
          <div class="col-md-4">
           ...
           <select id="updateStatus" name="updateStatus" class="form-control col-md-3" >
