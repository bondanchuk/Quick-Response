                ...
                <div class="row">
                    ...
                    <div class="col-sm-13">
                        ...
                        <div class="card-box table-responsive">
                            ...
                            <h4 class="m-t-0 header-title"><b>Tabel Daftar Nama Jalan</b></h4>

                              <h5><i>Menampilkan daftar nama jalan yang ada .</i></h5>
                            ...
                            <table id="table" class="hover dt-responsive" cellspacing="0" width="100%" >
                                  ...
                                  <thead>
                                    ...
                                    <tr>
                                      ...
                                      <th style="text-align: center;width:200px;">Nama Jalan</th>

                                      <th style="text-align: center;width:135px;">Kota/Kabupaten</th>

                                      <th style="text-align: center;width:95px;">Panjang Jalan</th>

                                      <th style="text-align: center;width:75px;">Fungsi Jalan</th>

                                      <th style="text-align: center;width:90px;">Detail</th>
                                  ...
                                  responsive: true,
                                          ...
                                          "ajax": {
                                              ...
                                              "url": "<?php echo site_url('Admin/DataJalan/ajax_list')?>",
...

                                      {
                                        ...
                                        $.ajax({
                                          ...
                                          url :"<?php echo base_url('index.php/Admin/DataJalan/ajax_edit')?>/"+id,
...

                                          {
                                              ...
                                              $('[name="idlapor"]').val(data.idJalan);

                                              $('[name="id"]').val(data.namaJalan);

                                              $('[name="nama"]').val(data.namaKota);

                                              $('[name="tgl"]').val(data.panjangJalan);

                                              $('[name="namaKota"]').val(data.fungsiJalan);
                                        ...
                                        var id = $("#idlapor").val();
                                         ...
                                         // ajax adding data to database
                                            ...
                                            $.ajax({
                                              ...
                                              url : "<?php echo base_url('index.php/Admin/DataJalan/ajax_confirm')?>/"+id,
...

                                              {
                                                ...
                                                if (data){
                                                 ...
                                                 $('#con-close-modal').modal('hide');
                                                  ...
                                                  $.Notification.notify('success','bottom right','Laporan Berhasil Diverifikasi', 'Laporan yang sudah diverifikasi akan masuk ke table laporan on-going!!.');
...

                                        {
                                          ...
                                          // ajax delete data to database
                                            ...
                                            $.ajax({
                                              ...
                                              url : "<?php echo site_url('Admin/DataJalan/ajax_delete')?>/"+id,
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group">
                                                      ...
                                                      <label class="control-label col-md-4" style="text-align : left;">Nama Kota/Kab</label>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group">
                                                      ...
                                                      <label class="control-label col-md-4" style="text-align : left;">Panjang Jalan</label>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group">
                                                      ...
                                                      <label class="control-label col-md-4" style="text-align : left;">Fungsi Jalan</label>
          ...
          <div class="col-md-7">
            ...
            <input type="text" class="form-control" id="namaKota" name="namaKota"/>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="submit" onclick="save()" class="btn btn-danger waves-effect waves-light">Update Jalan</button>
