        ...
        <div class="wrapper">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <h4 class="page-title">MENU DAFTAR TUNGGU</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-13">
                        ...
                        <div class="card-box table-responsive">
                            ...
                            <h4 class="m-t-0 header-title"><b>Tabel Daftar Tunggu</b></h4>

                              <h5><i>Menampilkan daftar pengaduan yang belum diverifikasi oleh operator. Klik detail untuk memverifikasi laporan.</i></h5>
                            ...
                            <table id="table" class="hover dt-responsive" cellspacing="0" width="100%" >
                                  ...
                                  responsive: true,
                                          ...
                                          "ajax": {
                                              ...
                                              "url": "<?php echo site_url('Admin/DaftarTunggu/ajax_list')?>",
...

                                      {
                                        ...
                                        $.ajax({
                                          ...
                                          url :"<?php echo base_url('index.php/Admin/DaftarTunggu/ajax_edit')?>/"+id,
...

                                          {
                                              ...
                                              $('[name="foto"]').html(data.fotoLaporan);
                                        ...
                                        var id = $("#idlapor").val();
                                         ...
                                         // ajax adding data to database
                                            ...
                                            $.ajax({
                                              ...
                                              url : "<?php echo base_url('index.php/Admin/DaftarTunggu/ajax_confirm')?>/"+id,
          ...
          : <span name="detail"></span>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="submit" onclick="save()" class="btn btn-danger waves-effect waves-light">Verifikasi Laporan</button>
