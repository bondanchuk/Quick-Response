...
class M_ListLaporan extends CI_Model {

  var $table = 'tbl_laporanuser';

  var $column = array('idLaporan', 'namaKota', 'idJalan', 'status');
   ...
   $this->db->where_not_in('status', 'Menunggu Verifikasi');

   $this->db->where_not_in('status', 'Terselesaikan');
